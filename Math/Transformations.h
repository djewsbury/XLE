...
namespace XLEMath
{
    ...
    void            Combine_IntoLHS(Float3x4&, const Float3x4&);
    void            Combine_IntoLHS(Float4x4&, const Float4x4&);
    void            Combine_IntoRHS(const Float3x4&, Float3x4&);
    void            Combine_IntoRHS(const Float4x4&, Float4x4&);
    ...
    Float3          TransformDirectionVector(const Float3x3& transform, Float3 dir);     // note 3d input -- this is transformation through a 3x3 rotation matrix
    Float3          TransformDirectionVector(const Float3x4& transform, Float3 dir);
    Float3          TransformDirectionVector(const Float4x4& transform, Float3 dir);
    ...
    Float3          TransformDirectionVectorByOrthonormalInverse(const Float3x4& transform, Float3 dir);
    Float3          TransformDirectionVectorByOrthonormalInverse(const Float4x4& transform, Float3 dir);
    ...
    Float3x4    MakeCameraToWorld3x4(const Float3& forward, const Float3& up, const Float3& position);
    Float3x4    MakeCameraToWorld3x4(const Float3& forward, const Float3& up, const Float3& right, const Float3& position);

	Float3x4    MakeObjectToWorld3x4(const Float3& forward, const Float3& up, const Float3& position);
	Float3x4    MakeObjectToWorld3x4(const Float3& forward, const Float3& up, const Float3& right, const Float3& position);
