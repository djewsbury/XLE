...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    auto    SharedBrowser::ProcessInput(InterfaceState& interfaceState, const OSServices::InputSnapshot& input) -> ProcessInputResult
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    auto ModelBrowser::SpecialProcessInput(InterfaceState& interfaceState, const OSServices::InputSnapshot& input) -> SpecialProcessInputResult
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    std::pair<const RenderCore::Metal::ShaderResourceView*, uint64_t> TextureBrowser::GetSRV(RenderCore::IThreadContext& devContext, const std::basic_string<ucs2>& filename)
    {
        ...
        if (!res) {
            utf8 utf8Filename[MaxPath];
            ucs2_2_utf8(AsPointer(filename.cbegin()), filename.size(), utf8Filename, dimof(utf8Filename));
            res = ::Assets::GetAssetFuturePtr<RenderCore::Techniques::DeferredShaderResource>((const char*)utf8Filename);
