...
namespace PlatformRig
{
    ...
    void    MainInputHandler::RemoveListener(IInputListener& listener)
    {
    ...
    InputContext::InputContext(const InputContext&) = default;
    InputContext& InputContext::operator=(const InputContext&) = default;
}
