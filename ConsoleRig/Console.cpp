...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			while (lua_next(L, -2) != 0) {
				...
				if (name) {
					if (!XlCompareString(name, "__propget")) {
						...
						if (length >= compareLength && !XlComparePrefixI(name, &input[iterateStart], compareLength))
	...
	class LuaScriptingInterface : public IConsoleScriptingInterface, public ILuaScriptInterface
	{
	public:
